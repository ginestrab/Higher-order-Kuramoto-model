...
b = incidence(graph(a)); %create incidence matrix
k = sum(a)'; %degrees
M=nnz(triu(a));
omegaedge = Omega + randn(M,1); %edge frequencies

omegahat = b*omegaedge; %projected frequencies
...
for sigma = 0:0.02:sigma_max;
    ...
    for t = 0:dt:Tmax
        ...
        thetas = thetas + dt*thetap; %forward Euler
        psis = psis + dt*psisp;
